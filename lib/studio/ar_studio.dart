...
class ObjectsOnPlanesWidget extends StatefulWidget {
  const ObjectsOnPlanesWidget({Key? key, required this.imageUrl,}) : super(key: key);
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        var newNode = ARNode(
            ...
            scale: v_math.Vector3(0.2, 0.2, 0.2),
            position: v_math.Vector3(0.0, 0.0, 0.0),
            rotation: v_math.Vector4(1.0, 0.0, 0.0, 0.0));
